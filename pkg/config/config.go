// Package config implements command-line flag parsing and devices
...
// Config holds the configuration of a Go program.
type Config struct {
	Options   Options `json:"gomqOptions"`
	ID        string  `json:"gomq_id,omitempty"`
	Transport string  `json:"gomq_transport,omitempty"` // zeromq, nanomsg, chan
	Control   string  `json:"gomq_control,omitempty"`
}

// Options holds the configuration of a Go MQ program.
type Options struct {
