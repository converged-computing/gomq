// Package fer provides a basic framework to run FairMQ-like processes in go- gomq
// Clients create Devices that exchange data via fer message queue sockets.
//
// A client device might look like so:
//
//	import "github.com/converged-computing/gomq/pkg/gomq"
//	import "github.com/converged-computing/gomq/pkg/config"
...
//	}
//
// A device needs to implement the Device interface:
//
...
// e.g.:
//
//	func (dev *myDevice) Init(ctl gomq.Controller) error {
...
//	}
//
//	func (dev *myDevice) Run(ctl gomq.Controller) error {
//	    for {
//	        select {
//	        case data := <-dev.imsg:
